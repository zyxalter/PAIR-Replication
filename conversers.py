...
class TargetLM():
    ...
    def get_response(self, prompts_list):
        ...
        Target_system_prompt = """You are a helpful, respectful and honest assistant. Always \
...
question, please don't share false information."""
        for conv in convs_list:
            conv.set_system_message(Target_system_prompt)
...
def load_indiv_model(model_name, device=None):
    ...
    if model_name in ["gpt-4", "gpt-3.5-turbo", "gpt-3.5-turbo-0125"]:
        lm = GPT(model_name)
